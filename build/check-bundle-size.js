...
const beforejs = fileSize('./before/mapmetrics-gl.js');
const beforecss = fileSize('./before/mapmetrics-gl.css');
const afterjs = fileSize('./after/mapmetrics-gl.js');
const aftercss = fileSize('./after/mapmetrics-gl.css');
...
| :--- | :---: | :---: | :---: |
| mapmetrics-gl.js | ${prettyBytes(beforejs.gzipped)} | ${prettyBytes(afterjs.gzipped)} | ${prettyBytes(afterjs.gzipped - beforejs.gzipped, { signed: true })} |
| mapmetrics-gl.css | ${prettyBytes(beforecss.gzipped)} | ${prettyBytes(aftercss.gzipped)} | ${prettyBytes(aftercss.gzipped - beforecss.gzipped, { signed: true })} |`);
