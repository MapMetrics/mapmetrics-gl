...
export type CustomRenderMethodInput = {
    ...
    */
    ...
    shaderData: {
        ...
        variantName: string;
        /**
         * The prelude code to add to the vertex shader to access Mapmetrics's `projectTile` projection function.
         * Depends on current projection.
         * @example
         * ```
    ...
    /**
     * Uniforms that should be passed to the vertex shader, if Mapmetrics's projection code is used.
