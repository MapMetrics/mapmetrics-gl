 ...
 * const start = mapmetricsgl.now();
 * // ... later ...
 * const elapsed = mapmetricsgl.now() - start;
 *
 * // During frozen time
 * mapmetricsgl.setNow(16.67);
 * console.log(mapmetricsgl.now()); // 16.67
 * mapmetricsgl.restoreNow();
 * console.log(mapmetricsgl.now()); // real time
 * ```
 */
