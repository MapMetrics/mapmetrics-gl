...
export class BoxZoomHandler implements Handler {
    ...
    mousemoveWindow(e: MouseEvent, point: Point) {
        ...
        if (!this._box) {
            this._box = DOM.create('div', 'mapmetricsgl-boxzoom', this._container);
            this._container.classList.add('mapmetricsgl-crosshair');
    ...
    reset() {
        ...
        this._container.classList.remove('mapmetricsgl-crosshair');
