...
export class CooperativeGesturesHandler implements Handler {
    ...
    _setupUI() {
        ...
        mapCanvasContainer.classList.add('mapmetricsgl-cooperative-gestures');
        this._container = DOM.create('div', 'mapmetricsgl-cooperative-gesture-screen', mapCanvasContainer);
        ...
        desktopDiv.className = 'mapmetricsgl-desktop-message';
        ...
        mobileDiv.className = 'mapmetricsgl-mobile-message';
    ...
    _destroyUI() {
        if (this._container) {
            ...
            const mapCanvasContainer = this._map.getCanvasContainer();
            mapCanvasContainer.classList.remove('mapmetricsgl-cooperative-gestures');
        }
    ...
    notifyGestureBlocked(gestureType: 'wheel_zoom' | 'touch_pan', originalEvent: Event) {
        ...
        this._container.classList.add('mapmetricsgl-show');
        setTimeout(() => {
            this._container.classList.remove('mapmetricsgl-show');
        }, 100);
    }
}
