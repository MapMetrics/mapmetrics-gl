...
export type MapOptions = {
    ...
    bearing?: number;
    /**
     * The initial pitch (tilt) of the map, measured in degrees away from the plane of the screen (0-85). If `pitch` is not specified in the constructor options, Mapmetrics GL JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`. Values greater than 60 degrees are experimental and may result in rendering issues. If you encounter any, please raise an issue with details in the MapLibre project.
     * @defaultValue 0
     */
    pitch?: number;
    /**
     ...
     * the schema described in the [MapLibre Style Specification](),
...
export class Map extends Camera {
     ...
     * [MapLibre Style Specification](), or a URL to such JSON.
     ...
     * MapLibre Style Specification's [source definition](sources) or
     ...
     * [`icon-image`](layers/#layout-symbol-icon-image),
     * [`background-pattern`](layers/#paint-background-background-pattern),
     * [`fill-pattern`](layers/#paint-fill-fill-pattern),
     * or [`line-pattern`](layers/#paint-line-line-pattern).
     *
    ...
    /**
     * Adds a [MapLibre style layer](layers)
     * to the map's style.
     *
     * A layer defines how data from a specified source will be styled. Read more about layer types
     * and available paint and layout properties in the [MapLibre Style Specification](layers).
     *
     * @param layer - The layer to add,
     * conforming to either the MapLibre Style Specification's [layer definition](layers) or,
     ...
     * [minimum zoom level](layers/#minzoom)
     * and [maximum zoom level](layers/#maxzoom))
     ...
     * [filter definition](layers/#filter).  If `null` or `undefined` is provided, the function removes any existing filter from the layer.
     * @param options - Options object.
     *
     * @example
     ...
     * @param value - The value of the layout property. Must be of a type appropriate for the property, as defined in the [MapLibre Style Specification]().
     * @param options - The options object.
     * @example
     * ```ts
     ...
     *
     * @param glyphsUrl - Glyph URL to set. Must conform to the [MapLibre Style Specification](glyphs/).
     * @param options - Options object.
     * @example
     * ```ts
     ...
     *
     * @param light - Light properties to set. Must conform to the [MapLibre Style Specification](light).
     * @param options - Options object.
     *
     * @example
     * ```ts
     ...
     *
     * @param sky - Sky properties to set. Must conform to the [MapLibre Style Specification](sky/).
     * @param options - Options object.
     *
     * @example
     * ```ts
     ...
     * - For vector or GeoJSON sources, using the [`promoteId`](sources/#vector-promoteId) option at the time the source is defined.
     * - For GeoJSON sources, using the [`generateId`](sources/#geojson-generateId) option to auto-assign an `id` based on the feature's index in the source data. If you change feature data using `map.getSource('some id').setData(..)`, you may need to re-apply state taking into account updated `id` values.
     *
     * _Note: You can use the [`feature-state` expression](expressions/#feature-state) to access the values in a feature's state object for the purposes of styling._
     *
     ...
     * Features are identified by their `feature.id` attribute, which can be any number or string.
     *
     * _Note: To access the values in a feature's state object for the purposes of styling the feature, use the [`feature-state` expression](expressions/#feature-state)._
     *
     * @param feature - Feature identifier. Feature objects returned from
     * {@link Map#queryRenderedFeatures} or event handlers can be used as feature identifiers.
