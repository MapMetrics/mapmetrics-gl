...
describe('Map', () => {
    ...
    describe('cooperativeGestures option', () => {
        test('cooperativeGesture container element is hidden from a11y tree', () => {
            ...
            expect(map.getContainer().querySelector('.mapmetricsgl-cooperative-gesture-screen').getAttribute('aria-hidden')).toBeTruthy();
        });
        ...
        test('cooperativeGesture container element is not available when cooperativeGestures not initialized', () => {
            ...
            expect(map.getContainer().querySelector('.mapmetricsgl-cooperative-gesture-screen')).toBeFalsy();
        });
