...
export class FullscreenControl extends Evented implements IControl {
    ...
    onAdd(map: Map): HTMLElement {
        ...
        this._controlContainer = DOM.create('div', 'mapmetricsgl-ctrl mapmetricsgl-ctrl-group');
        this._setupUI();
    ...
    _setupUI() {
        const button = this._fullscreenButton = DOM.create('button', (('mapmetricsgl-ctrl-fullscreen')), this._controlContainer);
        DOM.create('span', 'mapmetricsgl-ctrl-icon', button).setAttribute('aria-hidden', 'true');
        button.type = 'button';
        this._updateTitle();
    ...
    _handleFullscreenChange() {
        ...
        this._fullscreenButton.classList.toggle('mapmetricsgl-ctrl-shrink');
        this._fullscreenButton.classList.toggle('mapmetricsgl-ctrl-fullscreen');
        this._updateTitle();
    ...
    _togglePseudoFullScreen() {
        this._container.classList.toggle('mapmetricsgl-pseudo-fullscreen');
        this._handleFullscreenChange();
        this._map.resize();
    }
}
