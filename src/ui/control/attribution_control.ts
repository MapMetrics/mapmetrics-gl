...
export class AttributionControl implements IControl {
    ...
    onAdd(map: Map) {
        ...
        this._container = DOM.create('details', 'mapmetricsgl-ctrl mapmetricsgl-ctrl-attrib');
        this._compactButton = DOM.create('summary', 'mapmetricsgl-ctrl-attrib-button', this._container);
        this._compactButton.addEventListener('click', this._toggleAttribution);
        this._setElementTitle(this._compactButton, 'ToggleAttribution');
        this._innerContainer = DOM.create('div', 'mapmetricsgl-ctrl-attrib-inner', this._container);
    ...
    _toggleAttribution = () => {
        if (this._container.classList.contains('mapmetricsgl-compact')) {
            if (this._container.classList.contains('mapmetricsgl-compact-show')) {
                this._container.setAttribute('open', '');
                this._container.classList.remove('mapmetricsgl-compact-show');
            } else {
                this._container.classList.add('mapmetricsgl-compact-show');
    ...
    _updateCompact = () => {
        if (this._map.getCanvasContainer().offsetWidth <= 640 || this._compact) {
            ...
            this._container.setAttribute('open', '');
            if (this._container.classList.contains('mapmetricsgl-compact')) {
                this._container.classList.remove('mapmetricsgl-compact', 'mapmetricsgl-compact-show');
            }
        }
    };
