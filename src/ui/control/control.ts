 ...
 * element, which is often a `div` element. To use Mapmetrics GL JS's
 * default control styling, add the `mapmetricsgl-ctrl` class to your control's
 * node.
 *
 * @example
 * ```ts
 ...
 *         this._container.className = 'mapmetricsgl-ctrl';
