...
describe('ScaleControl', () => {
    test('appears in bottom-left by default', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.mapmetricsgl-ctrl-bottom-left .mapmetricsgl-ctrl-scale')
        ).toHaveLength(1);
    });
    ...
    test('appears in the position specified by the position option', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.mapmetricsgl-ctrl-top-left .mapmetricsgl-ctrl-scale')
        ).toHaveLength(1);
    });
    ...
    test('should change unit of distance after calling setUnit', () => {
        ...
        const selector = '.mapmetricsgl-ctrl-bottom-left .mapmetricsgl-ctrl-scale';
    ...
    test('onRemove cleans up event listeners and DOM', () => {
        ...
        expect(container.querySelectorAll('.mapmetricsgl-ctrl-scale')).toHaveLength(1);
        expect(scale._map).toBeDefined();

        map.removeControl(scale);

        expect(container.querySelectorAll('.mapmetricsgl-ctrl-scale')).toHaveLength(0);
