...
describe('FullscreenControl', () => {
    test('renders control', () => {
        ...
        expect(map.getContainer().querySelectorAll('.mapmetricsgl-ctrl-fullscreen')).toHaveLength(1);
    });
    ...
    test('uses pseudo fullscreen when fullscreen is not supported', () => {
        ...
        expect(mapContainer.classList.contains('mapmetricsgl-pseudo-fullscreen')).toBe(false);

        fullscreen._fullscreenButton.dispatchEvent(click);

        expect(mapContainer.classList.contains('mapmetricsgl-pseudo-fullscreen')).toBe(true);
    ...
    test('pseudo fullscreen can be used on custom container', () => {
        ...
        container.classList.remove('mapmetricsgl-pseudo-fullscreen');
        ...
        expect(container.classList.contains('mapmetricsgl-pseudo-fullscreen')).toBe(false);
        fullscreen._fullscreenButton.dispatchEvent(click);
        expect(container.classList.contains('mapmetricsgl-pseudo-fullscreen')).toBe(true);
        expect(fullscreen._container.tagName).toBe('BODY');
        fullscreen._fullscreenButton.dispatchEvent(click);
        expect(container.classList.contains('mapmetricsgl-pseudo-fullscreen')).toBe(false);
    });
