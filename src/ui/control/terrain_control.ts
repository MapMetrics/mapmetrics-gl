...
export class TerrainControl implements IControl {
    ...
    onAdd(map: Map) {
        ...
        this._terrainButton = DOM.create('button', 'mapmetricsgl-ctrl-terrain', this._container);
        DOM.create('span', 'mapmetricsgl-ctrl-icon', this._terrainButton).setAttribute('aria-hidden', 'true');
    ...
    _updateTerrainIcon = () => {
        this._terrainButton.classList.remove('mapmetricsgl-ctrl-terrain');
        this._terrainButton.classList.remove('mapmetricsgl-ctrl-terrain-enabled');
        if (this._map.terrain) {
            this._terrainButton.classList.add('mapmetricsgl-ctrl-terrain-enabled');
            this._terrainButton.title = this._map._getUIString('TerrainControl.Disable');
        } else {
            this._terrainButton.classList.add('mapmetricsgl-ctrl-terrain');
