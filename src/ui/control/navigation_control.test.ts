...
describe('NavigationControl', () => {
    test('appears in the top-right', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.mapmetricsgl-ctrl-top-right > .mapmetricsgl-ctrl')
        ).toHaveLength(1);
    });
    ...
    test('contains zoom in button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.mapmetricsgl-ctrl-zoom-in')
        ).toHaveLength(1);
    });
    ...
    test('contains zoom out button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.mapmetricsgl-ctrl-zoom-out')
        ).toHaveLength(1);
    });
    ...
    test('contains compass button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.mapmetricsgl-ctrl-compass')
        ).toHaveLength(1);
    });
    ...
    test('compass button reset action', () => {
        ...
        const navButton = map.getContainer().querySelector('.mapmetricsgl-ctrl-compass');
    ...
    test('zoom buttons round to nearest zoomSnap if defined', () => {
        ...
        const zoomInButton = map.getContainer().querySelector('.mapmetricsgl-ctrl-zoom-in');
