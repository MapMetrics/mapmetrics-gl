            ...
            parserOptions: {
                ...
                projectService: {
                    allowDefaultProject: [
                        ...
                        'eslint.config.js',
                        'postcss.config.js',
                        // MapMetrics fork addition: standalone Node upload scripts. They are not
                        // part of the TS project (not in tsconfig `include`), so without this the
                        // project service refuses to parse them and `npm run lint` fails.
                        'cdn-upload/*.js',
                    ],
